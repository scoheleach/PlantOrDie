...
data class PlantResult(val year: String?, val type: String?, val synonym: String?, val status: String?, val specifications: Specifications?, val sources: List<Sources1281556783>?, val soils_adaptation: Soils_adaptation?, val slug: String?, val seed: Seed?, val scientific_name: String?, val propagation: Propagation?, val products: Products?, val native_status: String?, val main_species_id: String?, val is_main_species: String?, val images: List<Images774813642>?, val id: String?, val growth: Growth?, val fruit_or_seed: Fruit_or_seed?, val foliage: Foliage?, val flower: Flower?, val family_common_name: String?, val duration: String?, val complete_data: String?, val common_name: String?, val bibliography: String?, val author: String?)
...
data class Images774813642(val url: String?)
...
data class Sources1281556783(val species_id: String?, val source_url: String?, val name: String?, val last_update: String?)
